...
(* OASIS_START *)
(* DO NOT EDIT (digest: 9c5fa0ccf3b704ec95eeb87c11992584) *)
(*
...
let setup_t =
  {
     ...
     package =
       {
          ...
          homepage = None;
          synopsis =
            "A dashboard displaying useful data from Mirage OS project and its related repositories.";
          description = None;
          categories = [];
               ...
               Executable
                 ({
                  ...
                  },
                   {
                      ...
                      bs_build_tools =
                        [ExternalTool "ocamlbuild"; ExternalTool "ocamlopt"];
                      bs_c_sources = [];
                      bs_data_files = [];
                   ...
                   {exec_custom = false; exec_main_is = "mirage_dashboard.ml"
                   })
            ];
          plugins =
     ...
     oasis_version = "0.4.5";
     oasis_digest = Some "A‹œ\027s\136\003À-›Ce‹XøÁ";
     oasis_exec = None;
     oasis_setup_args = [];
     setup_update = false
  };;
